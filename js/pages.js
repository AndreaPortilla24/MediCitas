...
function renderSobreNosotros(){return `<div class="page" style="max-width:880px">
  ...
  <div class="team-grid">
    ${[{n:'Andrea Portilla',r:'CEO & Fundadora',i:'AG'},{n:'Fernando Montañez',r:'Desarrollo',i:'CR'}].map(m=>`<div class="team-card"><div class="team-avatar">${m.i}</div><div style="font-weight:700;font-size:14px">${m.n}</div><div style="font-size:12px;color:var(--text3);margin-top:3px">${m.r}</div></div>`).join('')}
  </div>
